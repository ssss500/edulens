...
//
//     final monthExamModel = monthExamModelFromJson(jsonString);

// import 'dart:convert';

// MonthExamModel monthExamModelFromJson(String str) => MonthExamModel.fromJson(json.decode(str));

// String monthExamModelToJson(MonthExamModel data) => json.encode(data.toJson());

class MonthExamModel {
  MonthExamModel({
    this.id,
    this.title,
    this.desc,
  ...
  factory MonthExamModel.fromJson(Map<String, dynamic> json) => MonthExamModel(
    id: json["id"],
    title: json["title"],
    desc: json["desc"],
